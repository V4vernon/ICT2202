...
Finally note down where the contract is deployed to, as well as the abi.json file created so we can get it from the blockchain in the web server's app.py file 
