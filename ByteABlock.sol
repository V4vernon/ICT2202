...
contract ByteABlock {
    ...
    function addEvidenceItem(
        ...
        string memory _currStatus, string memory _purpose, string memory _notes
            ...
            emit evidenceAdded(_caseId, _evidId, _handlerId, _currStatus, _purpose, block.timestamp);
        }
        
    function modifyEvidenceStatus(uint _caseId, uint _evidId, uint _handlerId, string memory _newStatus, string memory _purpose) public{
