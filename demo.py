...
# Use this function to get the more accurate time of a transaction, instead of timestamp in transaction
# Inputs: Transaction Hash from event
# Outputs: Transaction timestamp
# def get_transaction_time(tx_hash):
...
#        )
# emits evidenceAdded(_caseId, _evidId, _handlerId, _currStatus, _purpose, block.timestamp)
...
# emit statusChanged(_caseId, _evidId, _handlerId, _newStatus, _purpose, block.timestamp)
# Remove the .call after the method name to execute the actual transaction
